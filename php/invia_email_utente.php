...
# http://localhost:8099/dms/php/invia_email_utente.php
...
$nome = $array_json['nome'] . " " . $array_json['cognome'];
$email = $array_json['email'];
...
$lista_destinatari = array(array("email" => $email, "nome" => $nome), array("email" => "beppe.merlino@gmail.com", "nome" => "Beppe Merlino"));
