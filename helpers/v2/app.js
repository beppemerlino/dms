    ...
    var t = {
            ...
            447: function (t, e, n) {
                ...
                var i = n(572),
                    ...
                    d = (function () {
                        function t() {
                            (this.content = a.h.get("content")),
                                (this.location = new o._(window.location.protocol, window.location.host, this.content.dataset.path || window.location.pathname)),
                                (this.search = new u.O()),
                                (this.j = new r.M()),
                                (this.T = new s.p()),
                                (this.version = "");
                        ...
                        return (
                            (t.prototype.t = function () {
                                ...
                                (t.prototype.k = function () {
                                    ...
                                    (this.placeholder = s),
                                        c.u.l ? s.appendChild(this.content) : s.appendChild(this.content.content),
                                        new l.N(this.placeholder).L(),
                                        document.body.insertBefore(e, document.body.firstChild),
                                        this.search.g(),
                                    this.location.R && !this.location.sandbox && this.T.g();
                                }),
                                (t.prototype.D = function () {
                                    ...
                                    var n = a.h.create("ul"),
                                        i = this.location.V;
                                    return (
                                        this.j.getItems(i).forEach(function (e) {
                                            var i = e.filename;
                                            "index.html" !== i || t.location.filesystem || (i = "./");
                                            var r = t.C(e.text, i, e.filename === t.location.filename, e.J);
                                            n.appendChild(r.div);
                                        }),
                                            e.appendChild(n),
                                            e
                                ...
                                (t.prototype.C = function (t, e, n, i) {
                                    var r = a.h.create("li");
                                    if ("string" == typeof e) {
                                ...
                                (t.prototype.P = function () {
                                    var t = this,
                                        ...
                                        o = this.A(r, n + i, this.location.S);
                                    return (
                                        e.appendChild(o.div),
                                            this.j.W().forEach(function (r) {
                                                var a = "" + n + r.V + "/" + i,
                                                    o = r.V === t.location.V,
                                                    u = t.A(r.text, a, o);
                                                e.appendChild(u.div);
                                ...
                                (t.prototype.A = function (t, e, n) {
                                    ...
                                    return (r.href = e), (r.innerText = t), n && (r.className = "dpw-header-item-selected"), i.appendChild(r), { div: i, a: r };
                                }),
                                t
                        );
                    })();
                ...
                var n = (function () {
                    ...
                    return (
                        Object.defineProperty(t.prototype, "S", {
                            ...
                            (t.test = function () {}),
                            (t.prototype.G = function () {
                                (this.filename = this.B(this.pathname)), (this.V = this.H(this.pathname)), (this.sandbox = this.K(this.pathname)), (this.R = this.U(this.host)), (this.filesystem = this.X(this.protocol));
                            }),
                            ...
                            (t.prototype.print = function () {
                                window.console.log(this.pathname, this.V, this.filename);
                            }),
                            t
                    );
                })();
            ...
            463: function (t, e, n) {
                Object.defineProperty(e, "o", { value: !0 }), (e.O = void 0);
                var i = n(143),
                    r = (function () {
                        function t() {
                            this.Y = null;
                        ...
                        return (
                            (t.prototype.g = function () {
                                ...
                                (t.prototype.$ = function (t) {
                                    var e = !t || "" === t.trim();
                                    e ? this.et() : this.nt(),
                                        i.h.query(".menu li").forEach(function (n) {
            ...
            151: function (t, e, n) {
                Object.defineProperty(e, "o", { value: !0 }), (e.N = void 0);
                var i = n(143),
                    r = n(827),
                    a = n(722),
                    o = (function () {
                            ...
                            (t.prototype.L = function () {
                                ...
                                (t.prototype.ut = function () {
                                    var t,
                                        e = this.rt();
                                    a.u.l
                                        ? (((t = i.h.create("div")).innerHTML = "<pre>" + r.lt.st(e.innerHTML) + "</pre>"), this.placeholder.appendChild(t))
                                        : (((t = i.h.create("pre")).innerText = r.lt.st(e.innerText)), this.placeholder.appendChild(t));
                                }),
                ...
                var n = [
                        {
                            ...
                            children: [
                                ...
                                { text: "Frameworks" },
                                { text: "Angular", filename: "angular.html", J: !0 },
                                { text: "React", filename: "react.html", J: !0 },
                                { text: "Vue", filename: "vue.html", J: !0 },
                                { text: "View Types" },
                                { text: "Day View", filename: "day.html" },
                                { text: "Days View", filename: "days.html" },
                                { text: "Week View", filename: "week.html" },
                                { text: "Resources View", filename: "resources.html", J: !0 },
                            ],
                        },
                        {
                            text: "Month",
                            ...
                            children: [
                                { text: "Main" },
                                { text: "JavaScript Monthly Event Calendar", filename: "index.html" },
                                { text: "Navigation" },
                                { text: "Navigator", filename: "navigator.html" },
                                { text: "Date Picker", filename: "datepicker.html" },
                                { text: "Next/Previous", filename: "nextprevious.html" },
                                ...
                                { text: "Events" },
                                { text: "Event Customization", filename: "eventcustomization.html" },
                                { text: "Event Deleting", filename: "eventdeleting.html", J: !0 },
                                { text: "Frameworks" },
                                { text: "Angular", filename: "angular.html", J: !0 },
                                { text: "React", filename: "react.html", J: !0 },
                                { text: "Vue", filename: "vue.html", J: !0 },
                        ...
                        { text: "Scheduler", V: "scheduler", children: [{ text: "JavaScript Scheduler", filename: "index.html" }] },
                    ],
                    i = (function () {
                        function t() {
                            (this.ct = {}), this.load();
