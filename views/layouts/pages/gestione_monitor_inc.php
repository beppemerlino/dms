...
<div id="app" class="container mt-5">
    ...
    <div class="card card-header-actions mx-auto">
        <div class="card-header">
            <img src="assets/img/icons/monitor.svg" height="32">Monitor
            <b-button size="sm" class="m-2" variant="teal" v-on:click="insertMonitor"><img src="assets/img/icons/plus-white.svg" style="height: 16px;" />&nbsp;Nuovo Monitor</b-button>
        </div>
        <div class="card-body" >
            <!-- // Filtro tabella -->
            <div class="form-row">
            ...
            <!-- // Tabella dei Monitor -->
            <div class="datatable">
                <b-table id="table" class="text-center"  striped bordered small hover :items="monitor_list" :fields="fields_table_nas" :current-page="pageNumber"
                    ...
                    <template #cell(actions)="row" >
                        <b-button size="sm" v-on:click="editMonitor(row.item)" variant="link" v-b-tooltip.hover title="Modifica Monitor"><img src="assets/img/icons/edit-blue.svg" style="height: 16px" /></b-button>
                        <b-button size="sm" v-on:click="deleteItem(row.item)" variant="link"  v-b-tooltip.hover title="Cancella Monitor"><img src="assets/img/icons/trash-red.svg" style="height: 16px" /></b-button>
                    </template>
    ...
    <div class="modal fade bd-example-modal-xl" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" id="modalEditMonitor">
        <div class="modal-dialog modal-xl">
            <form v-on:submit.prevent="salvaDati">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 style="text-transform: uppercase">{{ aggiungi }} MONITOR</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label for="nome">NOME MONITOR</label>
                                <b-form-input type="text" class="form-control form-control-sm" size="sm" id="nome" v-model="nome" placeholder="Nome monitor" required>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <b-form-input type="text" class="form-control form-control-sm" size="sm" id="resolution" v-model="resolution" placeholder="Risoluzione" required>
                            </div>
                            ...
                            <div class="col-md-4">
                                <label for="inc_size">POLLICI</label>
                                <b-form-select
                                        class="form-control form-control-sm"
                                        size="sm"
                                        id="inc_size"
                                        ...
                                        style="padding-top: 1px; padding-bottom: 1px;">
                                    <template #first>
                                        <b-form-select-option :value="null" disabled>-- Selezionare Pollici --</b-form-select-option>
                                    </template>
                                </b-form-select>
                            </div>
    ...
    <div class="modal fade" data-backdrop="static" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLongTitle">Cancellazione Monitor</h5>
                </div>
                <div class="modal-body">
                    <div>
                        <p>Cancella Monitor&nbsp;<strong>&nbsp;{{nome}}</strong>.<br><br>Premere "OK" per continuare...</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" v-on:click="closeModalDelete">Annulla</button>
                    <a type="button" class="btn btn-success" data-dismiss="modal" v-on:click="deleteMonitor">OK</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" data-backdrop="static" id="modalAvatar" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLongTitle">IMMAGINE MONITOR</h5>
                </div>
                <div class="modal-body">
