...
<div id="app" class="container-fluid mt-3">
    ...
    <div class="card card-header-actions mx-auto">
        <div class="card-header">
            <img src="assets/img/icons/software.svg" height="32">Software
            <b-button size="sm" class="m-2" variant="teal" v-on:click="insertSoftware"><img src="assets/img/icons/plus-white.svg" style="height: 16px;" />&nbsp;Nuovo Software</b-button>
        </div>
        <div class="card-body" >
            <!-- // Filtro tabella -->
            <div class="form-row">
            ...
            <!-- // Tabella dei Software -->
            <div class="datatable">
                <b-table id="table" class="text-center"  striped bordered small hover :items="software_list" :fields="fields_table_software" :current-page="pageNumber"
                    ...
                    <template #cell(actions)="row" >
                        <b-button size="sm" v-on:click="editSoftware(row.item)" variant="link" v-b-tooltip.hover title="Modifica Software"><img src="assets/img/icons/edit-blue.svg" style="height: 16px" /></b-button>
                        <b-button size="sm" v-on:click="deleteItem(row.item)" variant="link"  v-b-tooltip.hover title="Cancella Software"><img src="assets/img/icons/trash-red.svg" style="height: 16px" /></b-button>
                    </template>
    ...
    <div class="modal fade bd-example-modal-xl" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" id="modalEditSoftware">
        <div class="modal-dialog modal-xl">
            <form v-on:submit.prevent="salvaDati">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 style="text-transform: uppercase">{{ aggiungi }} SOFTWARE</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label for="id_pc">COMPUTER</label>
                                <b-form-select
                                            class="form-control form-control-sm"
                                            size="sm"
                                            id="id_pc"
                                            v-model="id_pc"
                                            :options="opt_computer"
                                            text-field="text"
                                            style="padding-top: 1px; padding-bottom: 1px;">
                                    <template #first>
                                        <b-form-select-option :value="null" disabled>-- Selezionare un Computer --</b-form-select-option>
                                    </template>
                                </b-form-select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label for="expired_date">DATA SCADENZA (Opzionale)</label>
                                <b-form-input type="date" class="form-control form-control-sm" size="sm" id="expired_date" v-model="expired_date" placeholder="RAM">
                            </div>
    ...
    <div class="modal fade" data-backdrop="static" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLongTitle">Cancellazione Software</h5>
                </div>
                <div class="modal-body">
                    <div>
                        <p>Cancella Software&nbsp;<strong>&nbsp;{{vendor}}-{{model}}</strong>.<br><br>Premere "OK" per continuare...</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" v-on:click="closeModalDelete">Annulla</button>
                    <a type="button" class="btn btn-success" data-dismiss="modal" v-on:click="deleteSoftware">OK</a>
                </div>
            </div>
        </div>
    </div>
