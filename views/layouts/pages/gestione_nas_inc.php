...
<div id="app" class="container mt-5">
    ...
    <div class="card card-header-actions mx-auto">
        <div class="card-header">
            <img src="assets/img/icons/nas2.svg" height="32">NAS
            <b-button size="sm" class="m-2" variant="teal" v-on:click="insertNas"><img src="assets/img/icons/plus-white.svg" style="height: 16px;" />&nbsp;Nuovo NAS</b-button>
        </div>
        <div class="card-body" >
            <!-- // Filtro tabella -->
            <div class="form-row">
            ...
            <!-- // Tabella dei NAS -->
            <div class="datatable">
                <b-table id="table" class="text-center"  striped bordered small hover :items="nas_list" :fields="fields_table_nas" :current-page="pageNumber"
                    ...
                    <template #cell(actions)="row" >
                        <b-button size="sm" v-on:click="editNas(row.item)" variant="link" v-b-tooltip.hover title="Modifica Nas"><img src="assets/img/icons/edit-blue.svg" style="height: 16px" /></b-button>
                        <b-button size="sm" v-on:click="deleteItem(row.item)" variant="link"  v-b-tooltip.hover title="Cancella Nas"><img src="assets/img/icons/trash-red.svg" style="height: 16px" /></b-button>
                    </template>
    ...
    <div class="modal fade bd-example-modal-xl" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" id="modalEditNas">
        <div class="modal-dialog modal-xl">
            <form v-on:submit.prevent="salvaDati">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 style="text-transform: uppercase">{{ aggiungi }} DISPOSITIVO NAS</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label for="num_hd">N. HARD-DISK</label>
                                <b-form-input type="number" min="0" max="100" class="form-control form-control-sm" size="sm" id="num_hd" v-model="num_hd" placeholder="Numero di hard disk" required>
                            </div>
                            <div class="col-md-2">
                                <label for="type_hd">TIPO DI HARD DISK</label>
                                <b-form-select
                                        class="form-control form-control-sm"
                                        size="sm"
                                        id="type_hd"
                                        ...
                                        style="padding-top: 1px; padding-bottom: 1px;">
                                    <template #first>
                                        <b-form-select-option :value="null" disabled>-- Selezionare una Tipo Hard Disk --</b-form-select-option>
                                    </template>
                                </b-form-select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="descr_raid">DESCR. RAID</label>
                                <b-form-select
                                        class="form-control form-control-sm"
                                        size="sm"
                                        id="fdescr_raid"
                                        ...
                                        style="padding-top: 1px; padding-bottom: 1px;">
                                    <template #first>
                                        <b-form-select-option :value="null" disabled>-- Selezionare un tipo RAID --</b-form-select-option>
                                    </template>
                                </b-form-select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <b-form-input type="text" class="form-control form-control-sm" size="sm" id="power_cell" v-model="power_cell" placeholder="Batteria interna">
                            </div>
                        </div>
    ...
    <div class="modal fade" data-backdrop="static" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLongTitle">Cancellazione Nas</h5>
                </div>
                <div class="modal-body">
                    <div>
                        <p>Cancella NAS&nbsp;<strong>&nbsp;{{nome}}</strong>.<br><br>Premere "OK" per continuare...</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" v-on:click="closeModalDelete">Annulla</button>
                    <a type="button" class="btn btn-success" data-dismiss="modal" v-on:click="deleteNas">OK</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" data-backdrop="static" id="modalAvatar" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLongTitle">IMMAGINE NAS</h5>
                </div>
                <div class="modal-body">
