...
<div id="app" class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
        <div class="mr-4 mb-3 mb-sm-0">
            ...
            <?php if ($_SESSION["NOME.GRUPPO"] == "SuperAdmins" || $_SESSION["NOME.GRUPPO"] == "Admins") {?>
    ...
    <div class="card card-header-actions mx-auto">
        <div class="card-header">
            <img src="assets/img/icons/dollar.svg" height="32">&nbsp;REPORT COMMESSE<b-button class="align-content-sm-center text-uppercase" variant="primary" size="sm" @click="esportaReport">Esporta</b-button>
        </div>
        <div class="card-body " >
            ...
            <div class="datatable">
                ...
                <b-table id="table" striped bordered small hover :items="reportList" :fields="fields_report"  :current-page="currentPage"
                    ...
                    <template #cell(codice)="item">
                        <b class="text-primary">{{ item.value.toUpperCase() }}</b>
                    </template>
                    <template #cell(tot_ore)="row">
